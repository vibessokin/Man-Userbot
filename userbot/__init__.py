...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://https://github.com/kintamanibeans/Man-Userbot"
)
...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/8a840b67197ad81f968be.jpg"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/8a840b67197ad81f968be.jpg"
)
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**TELEGRAM VIBES UBOT v{BOT_VER} is back up and running!**\n\n"
...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@idvibes"):
                buttons = paginate_help(0, dugmeler, "helpme")
                result = builder.photo(
                    file=logoman,
                    link_preview=False,
                    text=f"**✗ TELEGRAM VIBES Inline Menu ✗**\n\n✣ **Owner** [{user.first_name}](tg://user?id={user.id})\n✣ **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/idvibest"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://github.com/kintamanibeans/Man-Userbot"
                            ),
                        ],
                    ],
                    link_preview=False,
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/idvibes"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://github.com/kintamanibeans/Man-Userbot"
                            ),
                        ],
